...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container">
        <div class="row justify-content-center my-5 align-items-center vh-100">
                            ...
                            <div class="relative flex  justify-center  sm:items-center sm:pt-0">
                                @if (Route::has('login'))
                                    <div class="hidden  sm:block">
                                        ...
                                        @else
                                            <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500  btn btn-lg btn-info active">Log in</a>

                                            @if (Route::has('register'))
                                                <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500  btn btn-lg btn-light">Register</a>
                                            @endif
                                        @endauth
                                    </div>
                                @endif
            ...
            <div class="col-5">
                <img src="{{asset('img/chemist-img.svg')}}" alt="" class="img-fluid">
            </div>
        </div>
    </div>
    </body>
